...
public class LevelLoaderStepdefs implements En {
    ...
    public LevelLoaderStepdefs() {
        Given("the LevelLoader is instantiated", () -> ll = new LevelLoader(null));
        ...
        And("the TileMap has a world set to {int}", (Integer worldAttrValue) -> {
        ...
        And("a GameObject {string} has been created", (String gameObjectName) -> {
            assertNotNull(level.getMapObject(gameObjectName));
        });
