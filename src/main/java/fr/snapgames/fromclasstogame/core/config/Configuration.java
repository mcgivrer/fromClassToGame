...
public class Configuration {
        ...
        private void initializeArgParser(String configurationPath) {
                ...
                cm.add(new StringArgParser("title", "t", "title", "Define the game window title", "game.setup.title",
                                "title"));
                cm.add(new IntegerArgParser("width", "w", "width", "default width of the game screen",
                                "game.setup.width", 320));
                cm.add(new IntegerArgParser("height", "h", "height", "default height of the game screen",
                                "game.setup.height", 200));
                cm.add(new DoubleArgParser("scale", "sc", "scale", "default game screen scaling", "game.setup.scale",
                                2.0));
                cm.add(new IntegerArgParser("FPS", "f", "fps", "set the frame per second (25-60)", "game.setup.fps",
                                60));
                cm.add(new Vector2dArgParser("gravity", "g", "gravity", "define the default game gravity",
                                "game.setup.world.gravity", new Vector2d(0, -0.981)));
                cm.add(new IntegerArgParser("display", "di", "display", "set the default display to play the game",
                                "game.setup.screen", 0));
                cm.add(new StringArgParser("scenes", "ss", "scenes",
                                "Define the scene names and classes to initialize the game", "game.setup.scenes.list",
                                ""));
                cm.add(new StringArgParser("scene", "sd", "scene", "Define the default scene to start with",
                                "game.setup.scenes.default", ""));
                cm.add(new StringArgParser("config", "c", "config",
